...
@NgModule({
  ...
  declarations: [ForgotPasswordComponent, SigninComponent, SignupComponent, NotFoundComponent, ErrorComponent, Signup2Component, Signup3Component, Signup4Component, Signin3Component, Signin4Component, Signin2Component, ConfirmResetPasswordComponent, ProfileComponent, UpdatePasswordComponent, ConfirmUpdatePasswordComponent]
})
