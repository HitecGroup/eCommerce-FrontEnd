...
export class FooterComponent implements OnInit {
  ...
  constructor(
    ...
    iconRegistry.addSvgIconLiteral('face-icon',  sanitizer.bypassSecurityTrustHtml(FB_ICON));
    iconRegistry.addSvgIconLiteral('linkedin-icon',  sanitizer.bypassSecurityTrustHtml(LINKEDIN_ICON));
